...
--   `mobile_desc` varchar(255) NOT NULL,
--   `mobile_price` double NOT NULL,
--   `mobile_c_id` int(11) NOT NULL
-- ) ENGINE=InnoDB DEFAULT CHARSET=latin1;
-- 
-- --
-- -- Dumping data for table `software`
-- --
-- 
-- INSERT INTO `mobile` (`mobile_id`, `mobile_name`, `mobile_desc`, `mobile_price`, `mobile_c_id`) VALUES
-- (2, 'HTC desire', 'desription', 109.99, 3);
-- 
-- -- --------------------------------------------------------
-- 
-- --
...
-- --
-- 
-- INSERT INTO `mobilecompany` (`mc_id`, `mc_name`) VALUES
-- (2, 'Samsung'),
-- (3, 'HTC');
-- 
-- 
...
-- --INDEKSIRNJE NOVIH TABELA---
-- --
-- -- Indexes for table `mobile`
-- --
-- ALTER TABLE `mobile`
--   ADD PRIMARY KEY (`mobile_id`),
--   ADD KEY `mobile_c_id` (`mobile_c_id`);
-- 
-- --
